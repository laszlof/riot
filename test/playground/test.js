...
,'test-tag body{ background-color: red }');riot.tag('test-attr', '<test-attr class="$0" data-test="bar"> <h3>$1</h3></test-attr>', 
[function(){return ["something ", this.opts.class + 'joo' ," ", this.opts.class ]},
function(){return ["Child ", this.opts.class ]}], '');riot.tag('test-form', '<test-form> <textarea>$0</textarea> <input value="$0"> </test-form>', 
...
function(cell, i){return this.rows},
function(cell, i){return [ cell ," another"]}], 
...
function(p, i){return p.x * 10 + 5},
function(p, i){return p.y * 10 + 5}], 
